...
import { User, Key, ClipboardList, CheckCircle2 } from 'lucide-react';
...
export default function Profile() {
    ...
    return (
        <Layout activePage="profile" title="Profil Operator & Keamanan Kabupaten">
                ...
                <div className="panel-card" style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div style={{ borderTop: '1px solid var(--border-color)', margin: '1.5rem 0', paddingTop: '1.5rem' }}>
                            <h4 style={{ fontSize: '0.95rem', marginBottom: '1rem', display: 'flex', alignItems: 'center', gap: '0.5rem', margin: 0, paddingBottom: '1rem' }}>
